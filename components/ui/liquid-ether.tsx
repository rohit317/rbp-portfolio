  ...
  useEffect(() => {
    ...
    function makePaletteTexture(stops: string[]): THREE.DataTexture {
      ...
      if (Array.isArray(stops) && stops.length > 0) {
        ...
        arr = stops.length === 1 ? [first, first] : stops;
      } else {
        arr = ['#ffffff', '#ffffff'];
      }
      const w = arr.length;
...
`;
    ...
    class Viscous extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        if (typeof viscous === 'number' && uniforms.v) uniforms.v.value = viscous;
        ...
        for (let i = 0; i < iter; i++) {
          ...
          if (uniforms.velocity_new) uniforms.velocity_new.value = fbo_in.texture;
    ...
    class Pressure extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        if (this.uniforms && vel && pressure) {
          if (this.uniforms.velocity) this.uniforms.velocity.value = vel.texture;
          if (this.uniforms.pressure) this.uniforms.pressure.value = pressure.texture;
        }
        super.update();
      }
    }
